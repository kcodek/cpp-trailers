...
int main_Iterators_for_each(int arcg, char* argv[])
{
	...
	std::cout<<std::endl << "The values in myVector2(using const_iterator)" << std::endl;
	/*for (IntVectorIterator iter = myVector2.begin(); iter != myVector2.end(); iter++) {*/
	for (ConstIntVectorIterator iter = myVector2.begin(); iter != myVector2.end(); iter++) {
		std::cout << "The value is: " << *iter << std::endl;
	}
